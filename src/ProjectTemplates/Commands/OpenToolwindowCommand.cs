...
namespace ProjectTemplates.Commands
{
	/// <summary>
	/// Command handler
	/// </summary>
	internal sealed class OpenToolwindowCommand
	{
		...
		/// </summary>
		public static readonly Guid CommandSet = new Guid("3ee8e4f3-5c40-4abd-bde2-99539ac1a7ab");
		...
		private void Execute(object sender, EventArgs e)
		{
			...
			string title = "OpenToolwindowCommand";
